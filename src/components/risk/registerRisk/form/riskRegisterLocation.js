...
import {riskRegisterLocationForm} from '../../../ui/input/forms/risk';
import {checkValidity} from '../../../../shared/utility';
import styles from '../../risk.module.css';

const riskRegisterLocation = React.memo(props => {
    ...
    useEffect(() => {
        ...
        if(!formConfig)
            setFormConfig(riskRegisterLocationForm);
...
export default riskRegisterLocation;