...
import {riskRegisterWhoAreYouForm} from '../../../ui/input/forms/risk';
import {checkValidity} from '../../../../shared/utility';
import styles from '../../risk.module.css';

const riskRegisterWhoAreYou = React.memo(props => {
    ...
    useEffect(() => {
        ...
        if(!formConfig)
            setFormConfig(riskRegisterWhoAreYouForm);
...
export default riskRegisterWhoAreYou;