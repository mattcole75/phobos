...
import {forgotForm} from '../../ui/input/forms/authentication';
...
const forgot = React.memo(props => {
    ...
    useEffect(() => {
        ...
        if(!formConfig)
            setFormConfig(forgotForm);
            
    }, [formConfig, setFormConfig]);

    const {forgotHandler} = props;
    ...
    }, [status, formConfig, inputChangedHandler, forgotHandler]);
